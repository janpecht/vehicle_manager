...
import { createDamageSchema, updateDamagePositionSchema } from './damages.schemas.js';
...
router.patch('/:damageId', validate(updateDamagePositionSchema), damagesController.updatePosition);
